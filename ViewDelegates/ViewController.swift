...
//  ViewDelegates
//
//  Created by user218260 on 10/7/22.
//
...
class ViewController: UIViewController, NotificationSettingViewDelegate {
    ...
    override func viewDidLayoutSubviews() {
        ...
        notificationsView.frame =  CGRect(x: 10, y: view.safeAreaInsets.top,
                                          width: view.frame.size.width-20, height: view.frame.size.height-view.safeAreaInsets.top-view.safeAreaInsets.bottom)
    }
...
class NotificationSettingView: UIView {
    ...
    override func layoutSubviews() {
        ...
        label.frame = CGRect(x: 10, y: 30+imageSize+20,
                             width: frame.size.width-20, height: 100)
        
        button.frame = CGRect(x: 40, y: 160+imageSize,
                             width: frame.size.width-80, height: 50)
    }
}
